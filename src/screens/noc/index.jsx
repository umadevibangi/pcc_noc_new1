...
import NOCDetailsForm from "./NOCDetailsForm";
...
const steps = ["Applicant Details", "Applicant Address", "NOC Details"];

class NocApplication extends React.Component {
  state = {
    applyFor: "self",
    isOpen: true,
    activeStep: 0,
...
export const styledNocApplication = withStyles(styles)(NocApplication);

export default connect(
  mapStateToProps,
  mapDispatchToProps
)(styledNocApplication);
